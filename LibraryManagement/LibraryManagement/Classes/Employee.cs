    ...
    public class Employee : Person
    {
        ...
        public ObservableCollection<User> seeUsers()
        {
            ...
            for(int i=0;i<data.Rows.Count;i++)
            {
                ...
                {
                    User a = new User(data.Rows[i][PeopleTable.indexUserName].ToString(), data.Rows[i][PeopleTable.indexFirstName].ToString(), data.Rows[i][PeopleTable.indexLastName].ToString(), (Role)data.Rows[i][PeopleTable.indexRole],
